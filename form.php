...
<body>
    ...
    <div class="container mt-5">
        ...
        <form id="beasiswa-form" action="proses_daftar.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="beasiswa_id" name="beasiswa_id" disabled>
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" id="berkas" name="berkas" accept=".pdf" disabled>
                <div id="berkas-warning" class="text-danger"></div>
            </div>

            <div class="form-buttons-wrapper">
            <a href="index.php" class="btn btn-kembali">Kembali</a>
            <button type="submit" class="btn btn-daftar" id="daftar-button" disabled>Daftar</button>
            </div>
        </form>
    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            //tambah kolom IPS sesuai semester yang dipilih
            ...
            $(document).on('input', '.ips', function () {
                ...
                //validasi untuk jenis beasiswa yang dipilih
                if (ipk < 3) {
